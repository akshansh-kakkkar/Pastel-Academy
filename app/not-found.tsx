...
export default function Page(){
    return (
        <div className={` flex flex-col gap-12 w-full min-h-[75vh] justify-center items-center text-center ${interFont.className}`}>
            ...
            <div className={` bg-[#4b5a9c] cursor-pointer text-white text-3xl font-bold transition-all duration-300 hover:scale-[110%] px-12 sm:px-32 md:px-48 py-2 rounded-full`}><Link href={'/'}>Go Back</Link></div>
        </div>
    )
}